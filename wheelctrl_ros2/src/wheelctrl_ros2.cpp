...
void WheelCtrlRos2::set_wheel_parameter(){
  RCLCPP_INFO(this->get_logger(), "set_wheel_parameter");
    ...
    this->declare_parameter("moving_wheel.arguments", vector<double>(4,
    0.0)); this->declare_parameter("moving_wheel.length_x", 1.0);
    ...
    this->declare_parameter("measuring_wheel.distance", vector<double>(4,
    0.0)); this->declare_parameter("measuring_wheel.arguments",
    vector<double>(4, 0.0));
...
void WheelCtrlRos2::set_subclass() {
  ...
  if(measuring_wheel.type_name == "omni"){
    ...
    measure = std::make_shared<illias::MeasureSteering>(measuring_wheel,
                                                        current_pos);
  } else {
